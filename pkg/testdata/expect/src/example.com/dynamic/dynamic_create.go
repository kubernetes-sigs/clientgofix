...
func Create_117(c dynamic.Interface) {
	...
	subresources := []string{}
	c.Resource(schema.GroupVersionResource{}).Create(context.TODO(), u, opts)
	c.Resource(schema.GroupVersionResource{}).Create(context.TODO(), u, metav1.CreateOptions{})
	c.Resource(schema.GroupVersionResource{}).Create(context.TODO(), u, metav1.CreateOptions{}, "subresource")
	c.Resource(schema.GroupVersionResource{}).Create(context.TODO(), u, metav1.CreateOptions{}, subresources...)
}
