...
func Patch_117(c kubernetes.Interface, customClient versioned.Interface) {
	data := []byte{}
	subresources := []string{}
	c.CoreV1().Pods("").Patch("", types.ApplyPatchType, data)
	c.CoreV1().Pods("").Patch("", types.ApplyPatchType, data, "status")
	c.CoreV1().Pods("").Patch("", types.ApplyPatchType, data, subresources...)

	customClient.SamplecontrollerV1alpha1().Foos("").Patch("", types.ApplyPatchType, data)
	customClient.SamplecontrollerV1alpha1().Foos("").Patch("", types.ApplyPatchType, data, "status")
	customClient.SamplecontrollerV1alpha1().Foos("").Patch("", types.ApplyPatchType, data, subresources...)
}
