...
func Delete_117(c kubernetes.Interface, customClient versioned.Interface) {
	...
	customClient.SamplecontrollerV1alpha1().Foos("").Delete("", opts)
	customClient.SamplecontrollerV1alpha1().Foos("").Delete("", makeDeleteOptionsPtr())
	customClient.SamplecontrollerV1alpha1().Foos("").Delete("", nil)
	customClient.SamplecontrollerV1alpha1().Foos("").Delete("", &metav1.DeleteOptions{})
}
