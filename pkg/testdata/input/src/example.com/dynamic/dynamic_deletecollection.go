...
func DeleteCollection_117(c dynamic.Interface) {
	...
	c.Resource(schema.GroupVersionResource{}).DeleteCollection(opts, listOpts)
	c.Resource(schema.GroupVersionResource{}).DeleteCollection(makeDeleteOptionsPtr(), listOpts)
	c.Resource(schema.GroupVersionResource{}).DeleteCollection(nil, metav1.ListOptions{})
	c.Resource(schema.GroupVersionResource{}).DeleteCollection(&metav1.DeleteOptions{}, metav1.ListOptions{})
}
